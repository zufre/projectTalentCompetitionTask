                ...
                <div className="ui container">
                    ...
                    <div>
                        <span>
                            <Icon name='filter' />
                            Filter:
                            <Dropdown placeholder='Choose Filter' defaultValue={this.state.filterValue != "" ? this.state.filterValue : null } inline options={filterOptions} onChange={this.filterChangeHandler}/>
                        </span>
                        <span>
                            <Icon name='alternate outline calendar' />
                            Sort by Date:
                            <Dropdown inline options={sortOptions} defaultValue={this.state.sortBy.date == 'desc' ? "newest" : "oldest"} /*defaultValue={sortOptions[0].value}*/ onChange={this.sortChangeHandler}/>
                        </span>
                    </div>
                    <br />
